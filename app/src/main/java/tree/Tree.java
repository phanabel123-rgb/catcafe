...
public interface Tree<T extends Comparable<T>> extends Iterable<T> {
     ...
     *
     * <p>
     * The new object will be inserted as new leaf into the correct position in the tree. Adding an already stored
     * object does not change the tree.
     *
     * @param data
     ...
     *
     * <p>
     * The visitor needs to do all the heavy lifting, i.e. it needs to implement not only how to process the node's data
     * but also how to traverse the children of this node/leaf.
     *
     * @param visitor
     *            The visitor, which will work on this node (must not be {@code null})
